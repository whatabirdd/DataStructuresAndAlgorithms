...
class Main {
    public static void main(String[] args) {
        ...
        neighbors.add(new Edge(0,1));
        neighbors.add(new Edge(0,7));
        neighbors.add(new Edge(0,6));

        neighbors.add(new Edge(1,0));
        neighbors.add(new Edge(1,5));
        neighbors.add(new Edge(1,6));
        neighbors.add(new Edge(1,4));

        neighbors.add(new Edge(2,3));
        neighbors.add(new Edge(2, 4));

        neighbors.add(new Edge(3,2));

        neighbors.add(new Edge(4,1));
        neighbors.add(new Edge(4,2));

        neighbors.add(new Edge(5,1));

        neighbors.add(new Edge(6,0));
        neighbors.add(new Edge(6,1));
        neighbors.add(new Edge(6,7));

        neighbors.add(new Edge(7,0));
        neighbors.add(new Edge(7,6));
        // 3. Create the graph (name "graph") using the vertices and edges
        UnweightedGraph<String> graph = new UnweightedGraph<>(vertices, neighbors);
